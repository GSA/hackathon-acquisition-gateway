...
var Botkit = {
    ...
    connectWebsocket: function (ws_url) {
        ...
        that.socket.addEventListener('open', function (event) {
            ...
            that.trigger("message", {text:"Welcome, How can I help you?"});
            that.trigger("message", {text:"You can ask something like... <BR>What is available on the gateway?"});
            that.trigger("message", {text:"OR Type <strong>Help</strong> if you are not sure!"});
        });
    ...
    boot: function (user) {
        ...
        that.on('message', function (message) {
          if(message.text === 'Thank you for your feedback!') {
            that.input.disabled = true;
          //  Botkit.disconnect();
          }
        });
